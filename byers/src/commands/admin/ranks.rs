...
pub async fn autocomplete_ranks(
    ...
    ranks
        ...
        .map(|rank| AutocompleteChoice::new(rank.rank_name, rank.id))
}

#[poise::command(slash_command, ephemeral, owners_only)]
pub async fn add(
    ctx: ApplicationContext<'_>,
    #[description = "The rank name"] rank_name: String,
    #[description = "The hour requirement"] hour_requirement: i32,
    #[description = "The user this rank is for"] user_id: Option<User>,
) -> Result<(), Error> {
    let data = ctx.data();
    SlcbRank::create(
        &rank_name,
...
pub async fn update(
    ...
    #[autocomplete = "autocomplete_ranks"]
    rank: i32,
    #[description = "The new rank name"] rank_name: Option<String>,
    #[description = "The new hour requirement"] hour_requirement: Option<i32>,
    #[description = "The user this rank is for"] user_id: Option<User>,
) -> Result<(), Error> {
    let data = ctx.data();
    SlcbRank::update(
